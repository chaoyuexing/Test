...
import com.homework.teacher.teacher.videopublish.server.PublishSigListener;
import com.homework.teacher.teacher.videopublish.server.ReportVideoInfoListener;
import com.homework.teacher.teacher.videopublish.server.VideoDataMgr;
    ...
    private void publish() {
        mTXugcPublish.setListener(new TXUGCPublishTypeDef.ITXVideoPublishListener() {
            ...
            public void onPublishComplete(TXUGCPublishTypeDef.TXPublishResult result) {
                String videoUrl =result.retCode == 0 ? result.videoURL : result.descMsg;
