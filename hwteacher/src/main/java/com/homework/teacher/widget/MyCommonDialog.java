...
public class MyCommonDialog extends Dialog {
	...
	public MyCommonDialog(Context context, String title, String contentText,
	...
	public MyCommonDialog(Context context, String title, BaseAdapter mAdpater,
			OnItemClickListener mItemClickListener, String cancel, String ok) {
		this(context);
		this.title = title;
