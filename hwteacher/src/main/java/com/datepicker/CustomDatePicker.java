...
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    private TextView mTvHourUnit, mTvMinuteUnit,mTitleTextView;
     ...
     */
    public CustomDatePicker(Context context, Callback callback, String beginDateStr, String endDateStr,String title) {
        this(context, callback, DateFormatUtils.str2Long(beginDateStr, true),
                DateFormatUtils.str2Long(endDateStr, true),title);
    }
     ...
     */
    public CustomDatePicker(Context context, Callback callback, long beginTimestamp, long endTimestamp,String title) {
    ...
    private void initView() {
        ...
        mTitleTextView = (TextView) mPickerDialog.findViewById(R.id.tv_title);
