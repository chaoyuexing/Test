...
public abstract class Node<T> implements Serializable {
    ...
    public void setCurrMaxQueNum(int currMaxQueNum) {
        this.currMaxQueNum = currMaxQueNum;
    }
    ...
    public void setIsExpand(boolean isExpand) {
        ...
        if (isExpand) {
            _icon = R.drawable.work_list_ic_minus_circle;
        } else {
            _icon = R.drawable.work_list_ic_add_circle;
        }
    }
