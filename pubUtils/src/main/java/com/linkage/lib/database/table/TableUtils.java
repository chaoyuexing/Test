...
import com.linkage.lib.database.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.canonicalName
     */
    private static ConcurrentHashMap<String, com.linkage.lib.database.table.Id> entityIdMap = new ConcurrentHashMap<String, com.linkage.lib.database.table.Id>();

    public static synchronized com.linkage.lib.database.table.Id getId(Class<?> entityType) {
        ...
        com.linkage.lib.database.table.Id id = new com.linkage.lib.database.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getCanonicalName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.linkage.lib.database.table.Id id = getId(entityType);
